	...
	function initEmbeddedMessaging() {
		try {
			...
			window.addEventListener("onEmbeddedMessagingReady", () => {            
				...
				embeddedservice_bootstrap.prechatAPI.setHiddenPrechatFields( { "Access_Token" : "dedb9ddb-44e7-4c10-af4a-38fd9a5263d2", "Origin_Page" : "/home/my-accounts", "Session_Token" : "" });
			});
