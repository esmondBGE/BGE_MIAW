	...
	function initEmbeddedMessaging() {
		try {
			...
			window.addEventListener("onEmbeddedMessagingReady", () => {            
				...
				embeddedservice_bootstrap.prechatAPI.setHiddenPrechatFields( { "Access_Token" : "21839334-1d4f-43a3-a3c6-d90c8090c724", "IP_Address" : "255.255.255.255", "Origin_Page" : "Github" } );
			});
